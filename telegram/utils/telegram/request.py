...
class Request(object):
    ...
    def get(self, url, timeout=None, *args, **kwargs):
        """Request an URL.
    ...
    def delete(self, url, timeout=None, *args, **kwargs):
        urlopen_kwargs = {}

        if timeout is not None:
            urlopen_kwargs['timeout'] = Timeout(read=timeout, connect=self._connect_timeout)

        result = self._request_wrapper('DELETE', url, **urlopen_kwargs)
        return self._parse(result)

    def patch(self, url, data, timeout=None, *args, **kwargs):
        """Request an URL.
        ...
        if files:
            result = self._request_wrapper('PATCH', url, fields=data, **urlopen_kwargs)
        else:
    ...
    def post(self, url, data, timeout=None, *args, **kwargs):
        """Request an URL.
